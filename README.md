...
Также повторно пришлось обратиться к документации `ml-agent 19` для решения второго этапа задачи. Это закрепило навыки, полученные при создании RollerAgent.
